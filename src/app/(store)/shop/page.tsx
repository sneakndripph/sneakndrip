...
import { BRAND, FONTS, MOCK_PRODUCTS, BRANDS, SNEAKER_SIZES } from "@/lib/constants";
...
export default function ShopPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return list;
  }, [search, selectedBrands, selectedSizes, selectedGenders, availability, maxPrice, sort]);
        ...
        <div className="flex items-center gap-3 mb-8 flex-wrap">
          ...
          <div className="flex-1 min-w-[200px] relative">
            <input
              ...
              className="w-full px-4 py-3 pr-10 text-sm focus:outline-none transition-colors"
