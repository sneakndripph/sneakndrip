...
export default function NewProductPage() {
  ...
  const [sizeRows, setSizeRows] = useState<SizeRow[]>(
    () => SNEAKER_SIZES.map(s => ({ size: s, stock: 0, enabled: false }))
  );
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      fd.append("product", JSON.stringify({
        ...
        is_trending: trending, is_new: true,
        images: imageUrls,
      }));
  ...
  return (
    <div className="pb-24 lg:pb-0">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-admin-hero text-ink font-display font-medium tracking-[-0.02em]">Add product</h1>
      </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2">
                  ...
                  <input required value={name} onChange={e => handleNameChange(e.target.value)}
                    placeholder="Nike Air Force 1 '07 White" className={inputCls} />
                </div>
                <div className="sm:col-span-2">
                  <label className={labelCls}>Slug</label>
                  <input value={slug} onChange={e => handleSlugChange(e.target.value)}
                    placeholder="auto-generated-from-name" className={`${inputCls} font-mono text-admin-sm`} />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input value={colorway} onChange={e => setColorway(e.target.value)}
                    placeholder="White / White" className={inputCls} />
                </div>
                <div>
                  <label className={labelCls}>SKU</label>
                  <input value={sku} onChange={e => setSku(e.target.value)}
                    placeholder="NK-AF1-WHT-001" className={inputCls} />
                </div>
                <div className="sm:col-span-2">
